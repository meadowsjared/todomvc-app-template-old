 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $d(t){return va(void 0,t)}function va(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!jd(n)||(t[n]=va(t[n],e[n]));return t}function jd(t){return t!=="__proto__"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kd(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Ca(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Kd())}function zd(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Ea(){return ga.NODE_ADMIN===!0}function qd(){try{return typeof indexedDB=="object"}catch{return!1}}function Gd(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(n){e(n)}})}function Yd(){if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global;throw new Error("Unable to locate global object.")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sp="FirebaseError";class cs extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=sp,Object.setPrototypeOf(this,cs.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,wa.prototype.create)}}class wa{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?ip(r,s):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new cs(i,l,s)}}function ip(t,e){return t.replace(rp,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const rp=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ia=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=Xn(ar(r[0])||""),n=Xn(ar(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},op=function(t){const e=Ia(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},lp=function(t){const e=Ia(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ap{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(kp(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function kp(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const dr="@firebase/app",bl="0.9.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c_=n_;function Na(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:pr,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw bt.create("bad-app-name",{appName:String(i)});if(n||(n=tp()),!n)throw bt.create("no-options");const r=Bs.get(i);if(r){if(ur(n,r.options)&&ur(s,r.config))return r;throw bt.create("duplicate-app",{appName:i})}const o=new pp(i);for(const c of _r.values())o.addComponent(c);const l=new l_(n,s,o);return Bs.set(i,l),l}function a_(t=pr){const e=Bs.get(t);if(!e&&t===pr)return Na();if(!e)throw bt.create("no-app",{appName:t});return e}function un(t,e,n){var s;let i=(s=s_[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),zt.warn(l.join(" "));return}Us(new Jn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d_=1024,p_=30*24*60*60*1e3;class __{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new m_(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Il();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s)))return this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const r=new Date(i.date).valueOf();return Date.now()-r<=p_}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Il(),{heartbeatsToSend:n,unsentEntries:s}=g_(this._heartbeatsCache.heartbeats),i=Fs(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function Il(){return new Date().toISOString().substring(0,10)}function g_(t,e=d_){const n=[];let s=t.slice();for(const i of t){const r=n.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),Tl(n)>e){r.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Tl(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class m_{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return qd()?Gd().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await f_(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return wl(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return wl(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Tl(t){return Fs(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function y_(t){Us(new Jn("platform-logger",e=>new Ap(e),"PRIVATE")),Us(new Jn("heartbeat",e=>new __(e),"PRIVATE")),un(dr,bl,t),un(dr,bl,"esm2017"),un("fire-js","")}y_("");const Sl="@firebase/database",xl="0.14.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pa=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new C_(e)}}catch{}return new E_},Wt=Pa("localStorage"),gr=Pa("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Al="start",W_="close",H_="pLPCommand",V_="pRTLPCB",Ga="id",Ya="pw",Qa="ser",$_="cb",j_="seg",K_="ts",z_="d",q_="dframe",Xa=1870,Ja=30,G_=Xa-Ja,Y_=25e3,Q_=3e4;class sn{constructor(e,n,s,i,r,o,l){this.connId=e,this.repoInfo=n,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=hs(e),this.stats_=eo(n),this.urlFn=c=>(this.appCheckToken&&(c[yr]=this.appCheckToken),qa(n,Ka,c))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new U_(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Q_)),T_(()=>{if(this.isClosed_)return;this.scriptTagHolder=new to((...r)=>{const[o,l,c,a,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Al)this.id=l,this.password=c;else if(o===W_)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,l]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,l)},()=>{this.onClosed_()},this.urlFn);const s={};s[Al]="t",s[Qa]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[$_]=this.scriptTagHolder.uniqueCallbackIdentifier),s[La]=Zr,this.transportSessionId&&(s[Ba]=this.transportSessionId),this.lastSessionId&&(s[Va]=this.lastSessionId),this.applicationId&&(s[$a]=this.applicationId),this.appCheckToken&&(s[yr]=this.appCheckToken),typeof location<"u"&&location.hostname&&Ha.test(location.hostname)&&(s[Ua]=Wa);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){sn.forceAllow_=!0}static forceDisallow(){sn.forceDisallow_=!0}static isAvailable(){return sn.forceAllow_?!0:!sn.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!x_()&&!N_()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=me(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=ya(n),i=Ma(s,G_);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const s={};s[q_]="t",s[Ga]=e,s[Ya]=n,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=me(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class to{constructor(e,n,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=b_(),window[H_+this.uniqueCallbackIdentifier]=e,window[V_+this.uniqueCallbackIdentifier]=n,this.myIFrame=to.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(l){Ce("frame writing exception"),l.stack&&Ce(l.stack),Ce(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Ce("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Ga]=this.myID,e[Ya]=this.myPW,e[Qa]=this.currentSerial;let n=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Ja+s.length<=Xa;){const o=this.pendingSegs.shift();s=s+"&"+j_+i+"="+o.seg+"&"+K_+i+"="+o.ts+"&"+z_+i+"="+o.d,i++}return n=n+s,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,s){this.pendingSegs.push({seg:e,ts:n,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const s=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(s,Math.floor(Y_)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),n())},s.onerror=()=>{Ce("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cu,au;function yg(t){cu=t}function vg(t){au=t}class Cg extends mi{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?xn(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return B.MIN}maxPost(){return new B(qt,new _e("[PRIORITY-POST]",au))}makePost(e,n){const s=cu(e);return new B(n,new _e("[PRIORITY-POST]",s))}toString(){return".priority"}}const ae=new Cg;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jl=10*1e3,Dg=30*1e3,Mg=5*60*1e3;class Fg{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Og(e);const s=jl+(Dg-jl)*Math.random();Wn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Ae(e,(i,r)=>{r>0&&dt(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Wn(this.reportStats_.bind(this),Math.floor(Math.random()*2*Mg))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ys;class gm{constructor(){this.views=new Map}}function mm(t){b(!Ys,"__referenceConstructor has already been defined"),Ys=t}function ym(){return b(Ys,"Reference.ts has not been loaded"),Ys}function vm(t){return t.views.size===0}function po(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return b(r!=null,"SyncTree gave us an op for an invalid query."),Zl(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(Zl(o,e,n,s));return r}}function Cm(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let l=zs(n,i?s:null),c=!1;l?c=!0:s instanceof k?(l=uo(n,s),c=!1):(l=k.EMPTY_NODE,c=!1);const a=yi(new Yt(l,c,!1),new Yt(s,i,!1));return new hm(e,a)}return o}function Em(t,e,n,s,i,r){const o=Cm(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),pm(o,n),_m(o,n)}function bm(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const l=xt(t);if(i==="default")for(const[c,a]of t.views.entries())o=o.concat(Jl(a,n,s)),Xl(a)&&(t.views.delete(c),a.query._queryParams.loadsAllData()||r.push(a.query));else{const c=t.views.get(i);c&&(o=o.concat(Jl(c,n,s)),Xl(c)&&(t.views.delete(i),c.query._queryParams.loadsAllData()||r.push(c.query)))}return l&&!xt(t)&&r.push(new(ym())(e._repo,e._path)),{removed:r,events:o}}function bu(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function pn(t,e){let n=null;for(const s of t.views.values())n=n||dm(s,e);return n}function wu(t,e){if(e._queryParams.loadsAllData())return vi(t);{const s=e._queryIdentifier;return t.views.get(s)}}function Iu(t,e){return wu(t,e)!=null}function xt(t){return vi(t)!=null}function vi(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ay(t){let e="";const n=t.split("/");for(let s=0;s<n.length;s++)if(n[s].length>0){let i=n[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function uy(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const s=n.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):Re(`Invalid query segment '${n}' in query '${t}'`)}return e}const oc=function(t,e){const n=hy(t),s=n.namespace;n.domain==="firebase.com"&&ut(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&n.domain!=="localhost"&&ut("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||I_();const i=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new za(n.host,n.secure,s,i,e,"",s!==n.subdomain),path:new Q(n.pathString)}},hy=function(t){let e="",n="",s="",i="",r="",o=!0,l="https",c=443;if(typeof t=="string"){let a=t.indexOf("//");a>=0&&(l=t.substring(0,a-1),t=t.substring(a+2));let u=t.indexOf("/");u===-1&&(u=t.length);let h=t.indexOf("?");h===-1&&(h=t.length),e=t.substring(0,Math.min(u,h)),u<h&&(i=ay(t.substring(u,h)));const d=uy(t.substring(Math.min(t.length,h)));a=e.indexOf(":"),a>=0?(o=l==="https"||l==="wss",c=parseInt(e.substring(a+1),10)):a=e.length;const g=e.slice(0,a);if(g.toLowerCase()==="localhost")n="localhost";else if(g.split(".").length<=2)n=g;else{const C=e.indexOf(".");s=e.substring(0,C).toLowerCase(),n=e.substring(C+1),r=s}"ns"in d&&(r=d.ns)}return{host:e,port:c,domain:n,subdomain:s,secure:o,scheme:l,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return W(this._path)?null:tu(this._path)}get ref(){return new pt(this._repo,this._path)}get _queryIdentifier(){const e=$l(this._queryParams),n=Jr(e);return n==="{}"?"default":n}get _queryObject(){return $l(this._queryParams)}isEqual(e){if(e=as(e),!(e instanceof Ao))return!1;const n=this._repo===e._repo,s=no(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+lg(this._path)}}class pt extends Ao{constructor(e,n){super(e,n,new oo,!1)}get parent(){const e=su(this._path);return e===null?null:new pt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class os{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new Q(e),s=Js(this.ref,e);return new os(this._node.getChild(n),s,ae)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new os(i,Js(this.ref,s),ae)))}hasChild(e){const n=new Q(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Nr(t,e){return t=as(t),t._checkNotDeleted("ref"),e!==void 0?Js(t._root,e):t._root}function Js(t,e){return t=as(t),L(t._path)===null?zm("child","path",e,!1):Mu("child","path",e,!1),new pt(t._repo,de(t._path,e))}function dy(t){return Fu("remove",t._path),Rr(t,null)}function Rr(t,e){t=as(t),Fu("set",t._path),Km("set",e,t._path,!1);const n=new _i;return ny(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class ko{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Ku("value",this,new os(e.snapshotNode,new pt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new zu(this,e,n):null}matches(e){return e instanceof ko?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Po{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new zu(this,e,n):null}createEvent(e,n){b(e.childName!=null,"Child events should have a childName.");const s=Js(new pt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Ku(e.type,this,new os(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Po?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function py(t,e,n,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const c=n,a=(u,h)=>{rc(t._repo,t,l),c(u,h)};a.userCallback=n.userCallback,a.context=n.context,n=a}const o=new fy(n,r||void 0),l=e==="value"?new ko(o):new Po(e,o);return iy(t._repo,t,l),()=>rc(t._repo,t,l)}function _y(t,e,n,s){return py(t,"value",e,n,s)}mm(pt);wm(pt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ty(t){v_(c_),Us(new Jn("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return vy(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),un(Sl,xl,t),un(Sl,xl,"esm2017")}ct.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};ct.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};Ty();var Sy="firebase",xy="9.15.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */un(Sy,xy,"app");const Ny={apiKey:"AIzaSyDYbAbripgwbZKFfTCSqXzu116Lde_kwnE",authDomain:"todomvc-app-template-test.firebaseapp.com",databaseURL:"https://todomvc-app-template-test-default-rtdb.firebaseio.com",projectId:"todomvc-app-template-test",storageBucket:"todomvc-app-template-test.appspot.com",messagingSenderId:"492184533263",appId:"1:492184533263:web:d98c399c38d7f0c593667a"},Ry=Na(Ny),kr=wy(Ry),lc=Nr(kr,"todos");var lt=(t=>(t[t.UNSORTED=0]="UNSORTED",t[t.ASCENDING=1]="ASCENDING",t[t.DESCENDING=2]="DESCENDING",t))(lt||{});function Ts(t,e){return{checked:!1,message:t,id:e,key:e}}function Ay(t,e,n){switch(n){case lt.ASCENDING:return t.checked===e.checked?0:t.checked?1:-1;case lt.DESCENDING:return t.checked===e.checked?0:t.checked?-1:1;case lt.UNSORTED:return t.id===e.id?0:t.id>e.id?1:-1}}function ky(t){const e=t.val()&&Object.entries(t.val()).map(([n,s])=>(s.key=parseInt(n),s));return(e==null?void 0:e.filter(n=>n!==void 0))??[]}function Py(){return[Ts("Welcome to TodoMVC",0),Ts("This is a sample todo",1),Ts("Click on the words to edit a todo",2),Ts("Click on the X to delete a todo",3)]}const qu=Wd("todos",{state:()=>({_displayedTodos:[],_filter:"all",_sort:lt.UNSORTED,maxId:0}),getters:{todos:t=>{if(!t._displayedTodos)return;const e=t._displayedTodos;switch(e.sort((n,s)=>Ay(n,s,t._sort)),t._filter){case"unchecked":return e.filter(n=>!n.checked);case"checked":return e.filter(n=>n.checked);default:return e}},tasksLeft:t=>{var e;return((e=t._displayedTodos)==null?void 0:e.filter(n=>!n.checked).length)??0},filter:t=>t._filter},actions:{destroyTodo(t){const e=Nr(kr,"todos/"+t.key);dy(e).then(()=>{}).catch(n=>{console.warn(`Todo ${t.id} could not be saved.`,n)})},clearCompleted(){this._displayedTodos&&(this._displayedTodos=this._displayedTodos.filter(t=>!t.checked),this.saveAllTodos())},loadData(){_y(lc,t=>{this._displayedTodos=ky(t);const e=this._displayedTodos.reduce((n,s)=>s.id>n?s.id:n,0);this.maxId=e+1})},setFilter(t){this._filter=t},setSort(t){this._sort=t},updateTodo(t){if(!this._displayedTodos)return;const e=this._displayedTodos.findIndex(n=>t.id===n.id);this._displayedTodos[e]=t,this.saveTodo(t)},addTodo(t){var n,s;const e={checked:!1,message:t,id:this.maxId++,key:(((n=this._displayedTodos)==null?void 0:n.reduce((i,r)=>(r.key>i,r.key),0))??-1)+1};(s=this._displayedTodos)==null||s.push(e),this.saveTodo(e)},saveAllTodos(){var t;(t=this._displayedTodos)==null||t.forEach((e,n)=>{e.key=n}),Rr(lc,this._displayedTodos).then(()=>{}).catch(e=>{console.warn("Data could not be saved."+e)})},saveTodo(t){const e=Nr(kr,"todos/"+t.key);Rr(e,t).then(()=>{}).catch(n=>{console.warn(`Todo ${t.key} could not be saved.`,n)})},loadOnboardingTodos(){this._displayedTodos=Py(),this.saveAllTodos()}}}),Oy={class:"background"},Dy=ci({__name:"EmptyTodos",setup(t){const e=qu();function n(){e.loadOnboardingTodos()}return(s,i)=>(rt(),an("div",Oy,[re("p",{class:"message",onClick:n},"Load new onboarding Todos?")]))}});const Oo=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},My=Oo(Dy,[["__scopeId","data-v-f0980a39"]]),Fy=t=>(Uc("data-v-d98de8e2"),t=t(),Wc(),t),Ly={class:"view"},By=Fy(()=>re("input",{class:"edit",value:"Create a TodoMVC template"},null,-1)),Uy=ci({__name:"Todo",props:{modelValue:{type:Object,required:!0}},emits:["update:modelValue","destroyTodo"],setup(t,{emit:e}){const n=t,s=$t(n.modelValue.checked),i=$t(n.modelValue.message);cn(()=>n.modelValue,l=>{l.checked!==s.value&&(s.value=l.checked),l.message!==i.value&&(i.value=l.message)}),cn(()=>i.value,l=>{const c=n.modelValue;c.message=l,e("update:modelValue",c)});function r(){const l=n.modelValue;l.checked=n.modelValue.checked,s.value=n.modelValue.checked,e("update:modelValue",l)}function o(){e("destroyTodo")}return(l,c)=>(rt(),an("li",null,[re("div",Ly,[Zi(re("input",{"onUpdate:modelValue":[c[0]||(c[0]=a=>n.modelValue.checked=a),r],class:"toggle",title:"click to toggle checked",type:"checkbox"},null,512),[[wd,n.modelValue.checked]]),re("label",null,[Zi(re("input",{"onUpdate:modelValue":c[1]||(c[1]=a=>oe(i)?i.value=a:null),type:"text",class:wn({completed:ce(s)})},null,2),[[ua,ce(i)]])]),re("button",{class:"destroy",title:"delete todo",onClick:o})]),By]))}});const Wy=Oo(Uy,[["__scopeId","data-v-d98de8e2"]]),Gu=t=>(Uc("data-v-a4cd8bba"),t=t(),Wc(),t),Hy={class:"todoapp"},Vy={class:"header"},$y=Gu(()=>re("h1",null,"Jared's Todos",-1)),jy=["onKeypress"],Ky={class:"main"},zy=Gu(()=>re("input",{id:"sort-todos",class:"toggle-all",type:"checkbox"},null,-1)),qy={key:0,class:"todo-list"},Gy={class:"footer"},Yy={class:"todo-count"},Qy={class:"filters"},Xy=ci({__name:"App",setup(t){const e=qu();e.loadData(),$t(0);const n=$t(lt.UNSORTED),s=$t("");function i(u){e.destroyTodo(u)}function r(){e.clearCompleted()}function o(u){e.setFilter(u)}function l(){n.value=(n.value+1)%3,e.setSort(n.value)}function c(){e.addTodo(s.value),s.value=""}function a(u){e.updateTodo(u)}return(u,h)=>{const d=Wy,g=My,C=Hd;return rt(),an("section",Hy,[re("header",Vy,[$y,Zi(re("input",{"onUpdate:modelValue":h[0]||(h[0]=E=>oe(s)?s.value=E:null),class:"new-todo",placeholder:"What needs to be done?",autofocus:"",onKeypress:Rd(xd(c,["prevent"]),["enter"])},null,40,jy),[[ua,ce(s)]])]),re("section",Ky,[zy,re("label",{for:"sort-todos",title:"Sort todos",class:wn(["sort-arrow",{"sort-arrow-right":ce(n)===ce(lt).UNSORTED,"sort-arrow-up":ce(n)===ce(lt).ASCENDING,"sort-arrow-down":ce(n)===ce(lt).DESCENDING}]),onClick:l},"Sort todos",2),ce(e).todos?(rt(),an("ul",qy,[(rt(!0),an($e,null,Tf(ce(e).todos,E=>(rt(),rr(d,{key:E.id,modelValue:ce(e).todos[ce(e).todos.findIndex(O=>E.id===O.id)],"onUpdate:modelValue":[O=>ce(e).todos[ce(e).todos.findIndex(U=>E.id===U.id)]=O,O=>a(E)],onDestroyTodo:O=>i(E)},null,8,["modelValue","onUpdate:modelValue","onDestroyTodo"]))),128)),ce(e).todos.length===0?(rt(),rr(g,{key:0})):il("",!0)])):il("",!0)]),re("footer",Gy,[re("span",Yy,[re("strong",null,Ki(ce(e).tasksLeft),1),ra(" item"+Ki(ce(e).tasksLeft===1?"":"s")+" left",1)]),re("ul",Qy,[re("li",null,[Ue(C,{type:"button",active:ce(e).filter==="all",label:{displayText:"All",value:"all"},onClick:o},null,8,["active"])]),re("li",null,[Ue(C,{type:"button",active:ce(e).filter==="unchecked",label:{displayText:"Unchecked",value:"unchecked"},onClick:o},null,8,["active"])]),re("li",null,[Ue(C,{type:"button",active:ce(e).filter==="checked",label:{displayText:"Checked",value:"checked"},onClick:o},null,8,["active"])])]),re("button",{type:"button",class:"clear-completed",onClick:r}," Clear completed ")])])}}});const Jy=Oo(Xy,[["__scopeId","data-v-a4cd8bba"]]),Yu=Pd(Jy),Zy=Md();Yu.use(Zy);Yu.mount("#app");
