 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o_=e_;function Na(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:pr,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw bt.create("bad-app-name",{appName:String(i)});if(n||(n=Zd()),!n)throw bt.create("no-options");const r=Bs.get(i);if(r){if(ur(n,r.options)&&ur(s,r.config))return r;throw bt.create("duplicate-app",{appName:i})}const o=new fp(i);for(const c of _r.values())o.addComponent(c);const l=new r_(n,s,o);return Bs.set(i,l),l}function l_(t=pr){const e=Bs.get(t);if(!e&&t===pr)return Na();if(!e)throw bt.create("no-app",{appName:t});return e}function an(t,e,n){var s;let i=(s=t_[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),zt.warn(l.join(" "));return}Us(new Jn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function g_(t){Us(new Jn("platform-logger",e=>new Np(e),"PRIVATE")),Us(new Jn("heartbeat",e=>new d_(e),"PRIVATE")),an(dr,bl,t),an(dr,bl,"esm2017"),an("fire-js","")}g_("");const Sl="@firebase/database",xl="0.14.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class v_{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,n){n==null?delete this.cache_[e]:this.cache_[e]=n}get(e){return dt(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pa=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new y_(e)}}catch{}return new v_},Wt=Pa("localStorage"),gr=Pa("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M_{constructor(){this.counters_={}}incrementCounter(e,n=1){dt(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return Hd(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mi{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new B(vn,e),i=new B(vn,n);return this.compare(s,i)!==0}minPost(){return B.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vg=Math.log(2);class Cg{constructor(e){const n=r=>parseInt(Math.log(r)/vg,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Vs=function(t,e,n,s){t.sort(e);const i=function(c,a){const u=a-c;let h,d;if(u===0)return null;if(u===1)return h=t[c],d=n?n(h):h,new ge(d,h.node,ge.BLACK,null,null);{const g=parseInt(u/2,10)+c,C=i(c,g),E=i(g+1,a);return h=t[g],d=n?n(h):h,new ge(d,h.node,ge.BLACK,C,E)}},r=function(c){let a=null,u=null,h=t.length;const d=function(C,E){const O=h-C,U=h;h-=C;const he=i(O+1,U),D=t[O],X=n?n(D):D;g(new ge(X,D.node,E,null,he))},g=function(C){a?(a.left=C,a=C):(u=C,a=C)};for(let C=0;C<c.count;++C){const E=c.nextBitIsOne(),O=Math.pow(2,c.count-(C+1));E?d(O,ge.BLACK):(d(O,ge.BLACK),d(O,ge.RED))}return u},o=new Cg(t.length),l=r(o);return new Ne(s||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hi;const tn={};class ot{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return b(tn&&ae,"ChildrenNode.ts has not been loaded"),Hi=Hi||new ot({".priority":tn},{".priority":ae}),Hi}get(e){const n=yn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Ne?n:null}hasIndex(e){return dt(this.indexSet_,e.toString())}addIndex(e,n){b(e!==fn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(B.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=Vs(s,e.getCompare()):l=tn;const c=e.toString(),a=Object.assign({},this.indexSet_);a[c]=e;const u=Object.assign({},this.indexes_);return u[c]=l,new ot(u,a)}addToIndexes(e,n){const s=Ls(this.indexes_,(i,r)=>{const o=yn(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),i===tn)if(o.isDefinedOn(e.node)){const l=[],c=n.getIterator(B.Wrap);let a=c.getNext();for(;a;)a.name!==e.name&&l.push(a),a=c.getNext();return l.push(e),Vs(l,o.getCompare())}else return tn;else{const l=n.get(e.name);let c=i;return l&&(c=c.remove(new B(e.name,l))),c.insert(e,e.node)}});return new ot(s,this.indexSet_)}removeFromIndexes(e,n){const s=Ls(this.indexes_,i=>{if(i===tn)return i;{const r=n.get(e.name);return r?i.remove(new B(e.name,r)):i}});return new ot(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bg=!0;function ye(t,e=null){if(t===null)return k.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),b(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new _e(n,ye(e))}if(!(t instanceof Array)&&bg){const n=[];let s=!1;if(Ae(t,(o,l)=>{if(o.substring(0,1)!=="."){const c=ye(l);c.isEmpty()||(s=s||!c.getPriority().isEmpty(),n.push(new B(o,c)))}}),n.length===0)return k.EMPTY_NODE;const r=Vs(n,pg,o=>o.name,io);if(s){const o=Vs(n,ae.getCompare());return new k(r,ye(e),new ot({".priority":o},{".priority":ae}))}else return new k(r,ye(e),ot.Default)}else{let n=k.EMPTY_NODE;return Ae(t,(s,i)=>{if(dt(t,s)&&s.substring(0,1)!=="."){const r=ye(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(ye(e))}}gg(ye);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ig extends mi{compare(e,n){const s=e.node.compareTo(n.node);return s===0?xn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return B.MIN}maxPost(){return B.MAX}makePost(e,n){const s=ye(e);return new B(n,s)}toString(){return".value"}}const Tg=new Ig;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ro{constructor(e){this.index_=e}updateChild(e,n,s,i,r,o){b(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(n);return l.getChild(i).equals(s.getChild(i))&&l.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(n)?o.trackChildChange(ts(n,l)):b(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange(Cn(n,s)):o.trackChildChange(ns(n,s,l))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(n,s).withIndex(this.index_)}updateFullNode(e,n,s){return s!=null&&(e.isLeafNode()||e.forEachChild(ae,(i,r)=>{n.hasChild(i)||s.trackChildChange(ts(i,r))}),n.isLeafNode()||n.forEachChild(ae,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(ns(i,r,o))}else s.trackChildChange(Cn(i,r))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?k.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rg{constructor(){this.rootNode_=k.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jl=10*1e3,Pg=30*1e3,Og=5*60*1e3;class Dg{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new kg(e);const s=jl+(Pg-jl)*Math.random();Wn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Ae(e,(i,r)=>{r>0&&dt(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Wn(this.reportStats_.bind(this),Math.floor(Math.random()*2*Og))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ao(t,e){return yu(e,t)}function Wg(t,e,n,s,i){b(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=Vn(t.visibleWrites,e,n)),t.lastWriteId=s}function Hg(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function Vg(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);b(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&$g(l,s.path)?i=!1:qe(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return jg(t),!0;if(s.snap)t.visibleWrites=zl(t.visibleWrites,s.path);else{const l=s.children;Ae(l,c=>{t.visibleWrites=zl(t.visibleWrites,de(s.path,c))})}return!0}else return!1}function $g(t,e){if(t.snap)return qe(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&qe(de(t.path,n),e))return!0;return!1}function jg(t){t.visibleWrites=_u(t.allWrites,Kg,j()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Kg(t){return t.visible}function _u(t,e,n){let s=Xe.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let l;if(r.snap)qe(n,o)?(l=xe(n,o),s=Vn(s,l,r.snap)):qe(o,n)&&(l=xe(o,n),s=Vn(s,j(),r.snap.getChild(l)));else if(r.children){if(qe(n,o))l=xe(n,o),s=Kl(s,l,r.children);else if(qe(o,n))if(l=xe(o,n),W(l))s=Kl(s,j(),r.children);else{const c=yn(r.children,L(l));if(c){const a=c.getChild(te(l));s=Vn(s,j(),a)}}}else throw Sn("WriteRecord should have .snap or .children")}}return s}function gu(t,e,n,s,i){if(!s&&!i){const r=Xt(t.visibleWrites,e);if(r!=null)return r;{const o=wt(t.visibleWrites,e);if(wr(o))return n;if(n==null&&!br(o,j()))return null;{const l=n||k.EMPTY_NODE;return En(o,l)}}}else{const r=wt(t.visibleWrites,e);if(!i&&wr(r))return n;if(!i&&n==null&&!br(r,j()))return null;{const o=function(a){return(a.visible||i)&&(!s||!~s.indexOf(a.writeId))&&(qe(a.path,e)||qe(e,a.path))},l=_u(t.allWrites,o,e),c=n||k.EMPTY_NODE;return En(l,c)}}}function zg(t,e,n){let s=k.EMPTY_NODE;const i=Xt(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(ae,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=wt(t.visibleWrites,e);return n.forEachChild(ae,(o,l)=>{const c=En(wt(r,new Q(o)),l);s=s.updateImmediateChild(o,c)}),ql(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=wt(t.visibleWrites,e);return ql(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function qg(t,e,n,s,i){b(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=de(e,n);if(br(t.visibleWrites,r))return null;{const o=wt(t.visibleWrites,r);return wr(o)?i.getChild(n):En(o,i.getChild(n))}}function Gg(t,e,n,s){const i=de(e,n),r=Xt(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=wt(t.visibleWrites,i);return En(o,s.getNode().getImmediateChild(n))}else return null}function Yg(t,e){return Xt(t.visibleWrites,e)}function Qg(t,e,n,s,i,r,o){let l;const c=wt(t.visibleWrites,e),a=Xt(c,j());if(a!=null)l=a;else if(n!=null)l=En(c,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),d=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let g=d.getNext();for(;g&&u.length<i;)h(g,s)!==0&&u.push(g),g=d.getNext();return u}else return[]}function Xg(){return{visibleWrites:Xe.empty(),allWrites:[],lastWriteId:-1}}function zs(t,e,n,s){return gu(t.writeTree,t.treePath,e,n,s)}function uo(t,e){return zg(t.writeTree,t.treePath,e)}function Gl(t,e,n,s){return qg(t.writeTree,t.treePath,e,n,s)}function qs(t,e){return Yg(t.writeTree,de(t.treePath,e))}function Jg(t,e,n,s,i,r){return Qg(t.writeTree,t.treePath,e,n,s,i,r)}function ho(t,e,n){return Gg(t.writeTree,t.treePath,e,n)}function mu(t,e){return yu(de(t.treePath,e),t.writeTree)}function yu(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zg{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,s=e.childName;b(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),b(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(n==="child_added"&&r==="child_removed")this.changeMap.set(s,ns(s,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(n==="child_removed"&&r==="child_changed")this.changeMap.set(s,ts(s,i.oldSnap));else if(n==="child_changed"&&r==="child_added")this.changeMap.set(s,Cn(s,e.snapshotNode));else if(n==="child_changed"&&r==="child_changed")this.changeMap.set(s,ns(s,e.snapshotNode,i.oldSnap));else throw Sn("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class em{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const vu=new em;class fo{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new Yt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ho(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Qt(this.viewCache_),r=Jg(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ys;class pm{constructor(){this.views=new Map}}function _m(t){b(!Ys,"__referenceConstructor has already been defined"),Ys=t}function gm(){return b(Ys,"Reference.ts has not been loaded"),Ys}function mm(t){return t.views.size===0}function po(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return b(r!=null,"SyncTree gave us an op for an invalid query."),Zl(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(Zl(o,e,n,s));return r}}function ym(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let l=zs(n,i?s:null),c=!1;l?c=!0:s instanceof k?(l=uo(n,s),c=!1):(l=k.EMPTY_NODE,c=!1);const a=yi(new Yt(l,c,!1),new Yt(s,i,!1));return new am(e,a)}return o}function vm(t,e,n,s,i,r){const o=ym(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),fm(o,n),dm(o,n)}function Cm(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const l=xt(t);if(i==="default")for(const[c,a]of t.views.entries())o=o.concat(Jl(a,n,s)),Xl(a)&&(t.views.delete(c),a.query._queryParams.loadsAllData()||r.push(a.query));else{const c=t.views.get(i);c&&(o=o.concat(Jl(c,n,s)),Xl(c)&&(t.views.delete(i),c.query._queryParams.loadsAllData()||r.push(c.query)))}return l&&!xt(t)&&r.push(new(gm())(e._repo,e._path)),{removed:r,events:o}}function bu(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function dn(t,e){let n=null;for(const s of t.views.values())n=n||hm(s,e);return n}function wu(t,e){if(e._queryParams.loadsAllData())return vi(t);{const s=e._queryIdentifier;return t.views.get(s)}}function Iu(t,e){return wu(t,e)!=null}function xt(t){return vi(t)!=null}function vi(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qs;function Em(t){b(!Qs,"__referenceConstructor has already been defined"),Qs=t}function bm(){return b(Qs,"Reference.ts has not been loaded"),Qs}let wm=1;class ec{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ne(null),this.pendingWriteTree_=Xg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Tu(t,e,n,s,i){return Wg(t.pendingWriteTree_,e,n,s,i),i?ds(t,new Gt(fu(),e,n)):[]}function Ht(t,e,n=!1){const s=Hg(t.pendingWriteTree_,e);if(Vg(t.pendingWriteTree_,e)){let r=new ne(null);return s.snap!=null?r=r.set(j(),!0):Ae(s.children,o=>{r=r.set(new Q(o),!0)}),ds(t,new Ks(s.path,r,n))}else return[]}function Ci(t,e,n){return ds(t,new Gt(lo(),e,n))}function Im(t,e,n){const s=ne.fromObject(n);return ds(t,new rs(lo(),e,s))}function Tm(t,e){return ds(t,new is(lo(),e))}function Sm(t,e,n){const s=go(t,n);if(s){const i=mo(s),r=i.path,o=i.queryId,l=xe(r,e),c=new is(co(o),l);return yo(t,r,c)}else return[]}function Sr(t,e,n,s,i=!1){const r=e._path,o=t.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||Iu(o,e))){const c=Cm(o,e,n,s);mm(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const a=c.removed;if(l=c.events,!i){const u=a.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(r,(d,g)=>xt(g));if(u&&!h){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const g=Rm(d);for(let C=0;C<g.length;++C){const E=g[C],O=E.query,U=Nu(t,E);t.listenProvider_.startListening($n(O),Xs(t,O),U.hashFn,U.onComplete)}}}!h&&a.length>0&&!s&&(u?t.listenProvider_.stopListening($n(e),null):a.forEach(d=>{const g=t.queryToTagMap.get(Ei(d));t.listenProvider_.stopListening($n(d),g)}))}Am(t,a)}return l}function xm(t,e,n,s){const i=go(t,s);if(i!=null){const r=mo(i),o=r.path,l=r.queryId,c=xe(o,e),a=new Gt(co(l),c,n);return yo(t,o,a)}else return[]}function Nm(t,e,n,s){const i=go(t,s);if(i){const r=mo(i),o=r.path,l=r.queryId,c=xe(o,e),a=ne.fromObject(n),u=new rs(co(l),c,a);return yo(t,o,u)}else return[]}function tc(t,e,n,s=!1){const i=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(i,(d,g)=>{const C=xe(d,i);r=r||dn(g,C),o=o||xt(g)});let l=t.syncPointTree_.get(i);l?(o=o||xt(l),r=r||dn(l,j())):(l=new pm,t.syncPointTree_=t.syncPointTree_.set(i,l));let c;r!=null?c=!0:(c=!1,r=k.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((g,C)=>{const E=dn(C,j());E&&(r=r.updateImmediateChild(g,E))}));const a=Iu(l,e);if(!a&&!e._queryParams.loadsAllData()){const d=Ei(e);b(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const g=km();t.queryToTagMap.set(d,g),t.tagToQueryMap.set(g,d)}const u=ao(t.pendingWriteTree_,i);let h=vm(l,e,n,u,r,c);if(!a&&!o&&!s){const d=wu(l,e);h=h.concat(Pm(t,e,d))}return h}function _o(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,l)=>{const c=xe(o,e),a=dn(l,c);if(a)return a});return gu(i,e,r,n,!0)}function ds(t,e){return Su(e,t.syncPointTree_,null,ao(t.pendingWriteTree_,j()))}function Su(t,e,n,s){if(W(t.path))return xu(t,e,n,s);{const i=e.get(j());n==null&&i!=null&&(n=dn(i,j()));let r=[];const o=L(t.path),l=t.operationForChild(o),c=e.children.get(o);if(c&&l){const a=n?n.getImmediateChild(o):null,u=mu(s,o);r=r.concat(Su(l,c,a,u))}return i&&(r=r.concat(po(i,t,s,n))),r}}function xu(t,e,n,s){const i=e.get(j());n==null&&i!=null&&(n=dn(i,j()));let r=[];return e.children.inorderTraversal((o,l)=>{const c=n?n.getImmediateChild(o):null,a=mu(s,o),u=t.operationForChild(o);u&&(r=r.concat(xu(u,l,c,a)))}),i&&(r=r.concat(po(i,t,s,n))),r}function Nu(t,e){const n=e.query,s=Xs(t,n);return{hashFn:()=>(um(e)||k.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Sm(t,n._path,s):Tm(t,n._path);{const r=x_(i,n);return Sr(t,n,null,r)}}}}function Xs(t,e){const n=Ei(e);return t.queryToTagMap.get(n)}function Ei(t){return t._path.toString()+"$"+t._queryIdentifier}function go(t,e){return t.tagToQueryMap.get(e)}function mo(t){const e=t.indexOf("$");return b(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new Q(t.substr(0,e))}}function yo(t,e,n){const s=t.syncPointTree_.get(e);b(s,"Missing sync point for query tag that we're tracking");const i=ao(t.pendingWriteTree_,e);return po(s,n,i,null)}function Rm(t){return t.fold((e,n,s)=>{if(n&&xt(n))return[vi(n)];{let i=[];return n&&(i=bu(n)),Ae(s,(r,o)=>{i=i.concat(o)}),i}})}function $n(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(bm())(t._repo,t._path):t}function Am(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=Ei(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function km(){return wm++}function Pm(t,e,n){const s=e._path,i=Xs(t,e),r=Nu(t,n),o=t.listenProvider_.startListening($n(e),i,r.hashFn,r.onComplete),l=t.syncPointTree_.subtree(s);if(i)b(!xt(l.value),"If we're adding a query, it shouldn't be shadowed");else{const c=l.fold((a,u,h)=>{if(!W(a)&&u&&xt(u))return[vi(u).query];{let d=[];return u&&(d=d.concat(bu(u).map(g=>g.query))),Ae(h,(g,C)=>{d=d.concat(C)}),d}});for(let a=0;a<c.length;++a){const u=c[a];t.listenProvider_.stopListening($n(u),Xs(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ly(t){let e="";const n=t.split("/");for(let s=0;s<n.length;s++)if(n[s].length>0){let i=n[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function cy(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const s=n.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):Re(`Invalid query segment '${n}' in query '${t}'`)}return e}const oc=function(t,e){const n=ay(t),s=n.namespace;n.domain==="firebase.com"&&ut(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&n.domain!=="localhost"&&ut("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||b_();const i=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new za(n.host,n.secure,s,i,e,"",s!==n.subdomain),path:new Q(n.pathString)}},ay=function(t){let e="",n="",s="",i="",r="",o=!0,l="https",c=443;if(typeof t=="string"){let a=t.indexOf("//");a>=0&&(l=t.substring(0,a-1),t=t.substring(a+2));let u=t.indexOf("/");u===-1&&(u=t.length);let h=t.indexOf("?");h===-1&&(h=t.length),e=t.substring(0,Math.min(u,h)),u<h&&(i=ly(t.substring(u,h)));const d=cy(t.substring(Math.min(t.length,h)));a=e.indexOf(":"),a>=0?(o=l==="https"||l==="wss",c=parseInt(e.substring(a+1),10)):a=e.length;const g=e.slice(0,a);if(g.toLowerCase()==="localhost")n="localhost";else if(g.split(".").length<=2)n=g;else{const C=e.indexOf(".");s=e.substring(0,C).toLowerCase(),n=e.substring(C+1),r=s}"ns"in d&&(r=d.ns)}return{host:e,port:c,domain:n,subdomain:s,secure:o,scheme:l,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return W(this._path)?null:tu(this._path)}get ref(){return new pt(this._repo,this._path)}get _queryIdentifier(){const e=$l(this._queryParams),n=Jr(e);return n==="{}"?"default":n}get _queryObject(){return $l(this._queryParams)}isEqual(e){if(e=as(e),!(e instanceof Ao))return!1;const n=this._repo===e._repo,s=no(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+rg(this._path)}}class pt extends Ao{constructor(e,n){super(e,n,new oo,!1)}get parent(){const e=su(this._path);return e===null?null:new pt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class os{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new Q(e),s=Js(this.ref,e);return new os(this._node.getChild(n),s,ae)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new os(i,Js(this.ref,s),ae)))}hasChild(e){const n=new Q(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Nr(t,e){return t=as(t),t._checkNotDeleted("ref"),e!==void 0?Js(t._root,e):t._root}function Js(t,e){return t=as(t),L(t._path)===null?jm("child","path",e,!1):Mu("child","path",e,!1),new pt(t._repo,de(t._path,e))}function hy(t){return Fu("remove",t._path),Rr(t,null)}function Rr(t,e){t=as(t),Fu("set",t._path),$m("set",e,t._path,!1);const n=new _i;return ey(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class ko{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Ku("value",this,new os(e.snapshotNode,new pt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new zu(this,e,n):null}matches(e){return e instanceof ko?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Po{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new zu(this,e,n):null}createEvent(e,n){b(e.childName!=null,"Child events should have a childName.");const s=Js(new pt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Ku(e.type,this,new os(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Po?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function fy(t,e,n,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const c=n,a=(u,h)=>{rc(t._repo,t,l),c(u,h)};a.userCallback=n.userCallback,a.context=n.context,n=a}const o=new uy(n,r||void 0),l=e==="value"?new ko(o):new Po(e,o);return ny(t._repo,t,l),()=>rc(t._repo,t,l)}function dy(t,e,n,s){return fy(t,"value",e,n,s)}_m(pt);Em(pt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const py="FIREBASE_DATABASE_EMULATOR_HOST",Ar={};let _y=!1;function gy(t,e,n,s){t.repoInfo_=new za(`${e}:${n}`,!1,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams),s&&(t.authTokenProvider_=s)}function my(t,e,n,s,i){let r=s||t.options.databaseURL;r===void 0&&(t.options.projectId||ut("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ce("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=oc(r,i),l=o.repoInfo,c,a;typeof process<"u"&&process.env&&(a=process.env[py]),a?(c=!0,r=`http://${a}?ns=${l.namespace}`,o=oc(r,i),l=o.repoInfo):c=!o.repoInfo.secure;const u=i&&c?new hn(hn.OWNER):new O_(t.name,t.options,e);Km("Invalid Firebase Database URL",o),W(o.path)||ut("Database URL must point to the root of a Firebase Database (not including a child path).");const h=vy(l,t,u,new P_(t.name,n));return new Cy(h,t)}function yy(t,e){const n=Ar[e];(!n||n[t.key]!==t)&&ut(`Database ${e}(${t.repoInfo_}) has already been deleted.`),sy(t),delete n[t.key]}function vy(t,e,n,s){let i=Ar[e.name];i||(i={},Ar[e.name]=i);let r=i[t.toURLString()];return r&&ut("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Qm(t,_y,n,s),i[t.toURLString()]=r,r}class Cy{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Xm(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new pt(this._repo,j())),this._rootInternal}_delete(){return this._rootInternal!==null&&(yy(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ut("Cannot call "+e+" on a deleted database.")}}function Ey(t=l_(),e){const n=s_(t,"database").getImmediate({identifier:e}),s=Jd("database");return s&&by(n,...s),n}function by(t,e,n,s={}){t=as(t),t._checkNotDeleted("useEmulator"),t._instanceStarted&&ut("Cannot call useEmulator() after instance has already been initialized.");const i=t._repoInternal;let r;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&ut('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new hn(hn.OWNER);else if(s.mockUserToken){const o=typeof s.mockUserToken=="string"?s.mockUserToken:ep(s.mockUserToken,t.app.options.projectId);r=new hn(o)}gy(i,e,n,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wy(t){m_(o_),Us(new Jn("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return my(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),an(Sl,xl,t),an(Sl,xl,"esm2017")}ct.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};ct.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};wy();var Iy="firebase",Ty="9.15.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */an(Iy,Ty,"app");const Sy={apiKey:"AIzaSyDYbAbripgwbZKFfTCSqXzu116Lde_kwnE",authDomain:"todomvc-app-template-test.firebaseapp.com",databaseURL:"https://todomvc-app-template-test-default-rtdb.firebaseio.com",projectId:"todomvc-app-template-test",storageBucket:"todomvc-app-template-test.appspot.com",messagingSenderId:"492184533263",appId:"1:492184533263:web:d98c399c38d7f0c593667a"},xy=Na(Sy),kr=Ey(xy),lc=Nr(kr,"todos");var lt=(t=>(t[t.UNSORTED=0]="UNSORTED",t[t.ASCENDING=1]="ASCENDING",t[t.DESCENDING=2]="DESCENDING",t))(lt||{});function Ts(t,e){return{checked:!1,message:t,id:e,key:e}}function Ny(t,e,n){switch(n){case lt.ASCENDING:return t.checked===e.checked?0:t.checked?1:-1;case lt.DESCENDING:return t.checked===e.checked?0:t.checked?-1:1;case lt.UNSORTED:return t.id===e.id?0:t.id>e.id?1:-1}}function Ry(t){const e=t.val()&&Object.entries(t.val()).map(([n,s])=>(s.key=parseInt(n),s));return(e==null?void 0:e.filter(n=>n!==void 0))??[]}function Ay(){return[Ts("Welcome to TodoMVC",0),Ts("This is a sample todo",1),Ts("Click on the words to edit a todo",2),Ts("Click on the X to delete a todo",3)]}const qu=Bd("todos",{state:()=>({_displayedTodos:[],_filter:"all",_sort:lt.UNSORTED,maxId:0}),getters:{todos:t=>{if(!t._displayedTodos)return;const e=t._displayedTodos;switch(e.sort((n,s)=>Ny(n,s,t._sort)),t._filter){case"unchecked":return e.filter(n=>!n.checked);case"checked":return e.filter(n=>n.checked);default:return e}},tasksLeft:t=>{var e;return((e=t._displayedTodos)==null?void 0:e.filter(n=>!n.checked).length)??0},filter:t=>t._filter},actions:{destroyTodo(t){const e=Nr(kr,"todos/"+t.key);hy(e).then(()=>{}).catch(n=>{console.warn(`Todo ${t.id} could not be saved.`,n)})},clearCompleted(){this._displayedTodos&&(this._displayedTodos=this._displayedTodos.filter(t=>!t.checked),this.saveAllTodos())},loadData(){dy(lc,t=>{this._displayedTodos=Ry(t);const e=this._displayedTodos.reduce((n,s)=>s.id>n?s.id:n,0);this.maxId=e+1})},setFilter(t){this._filter=t},setSort(t){this._sort=t},updateTodo(t){if(!this._displayedTodos)return;const e=this._displayedTodos.findIndex(n=>t.id===n.id);this._displayedTodos[e]=t,this.saveTodo(t)},addTodo(t){var n,s;const e={checked:!1,message:t,id:this.maxId++,key:(((n=this._displayedTodos)==null?void 0:n.reduce((i,r)=>(r.key>i,r.key),0))??-1)+1};(s=this._displayedTodos)==null||s.push(e),this.saveTodo(e)},saveAllTodos(){var t;(t=this._displayedTodos)==null||t.forEach((e,n)=>{e.key=n}),Rr(lc,this._displayedTodos).then(()=>{}).catch(e=>{console.warn("Data could not be saved."+e)})},saveTodo(t){const e=Nr(kr,"todos/"+t.key);Rr(e,t).then(()=>{}).catch(n=>{console.warn(`Todo ${t.key} could not be saved.`,n)})},loadOnboardingTodos(){this._displayedTodos=Ay(),this.saveAllTodos()}}}),ky={class:"background"},Py=ci({__name:"EmptyTodos",setup(t){const e=qu();function n(){e.loadOnboardingTodos()}return(s,i)=>(rt(),cn("div",ky,[re("p",{class:"message",onClick:n},"Load new onboarding Todos?")]))}});const Oo=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},Oy=Oo(Py,[["__scopeId","data-v-f0980a39"]]),Dy=t=>(Uc("data-v-064692d8"),t=t(),Wc(),t),My={class:"view"},Fy=Dy(()=>re("input",{class:"edit",value:"Create a TodoMVC template"},null,-1)),Ly=ci({__name:"Todo",props:{modelValue:{type:Object,required:!0}},emits:["update:modelValue","destroyTodo"],setup(t,{emit:e}){const n=t,s=$t(n.modelValue.checked),i=$t(n.modelValue.message);ln(()=>n.modelValue,l=>{l.checked!==s.value&&(s.value=l.checked),l.message!==i.value&&(i.value=l.message)}),ln(()=>i.value,l=>{const c=n.modelValue;c.message=l,e("update:modelValue",c)});function r(){const l=n.modelValue;l.checked=n.modelValue.checked,s.value=n.modelValue.checked,e("update:modelValue",l)}function o(){e("destroyTodo")}return(l,c)=>(rt(),cn("li",null,[re("div",My,[Zi(re("input",{"onUpdate:modelValue":[c[0]||(c[0]=a=>n.modelValue.checked=a),r],class:"toggle",title:"click to toggle checked",type:"checkbox"},null,512),[[wd,n.modelValue.checked]]),re("label",null,[Zi(re("input",{"onUpdate:modelValue":c[1]||(c[1]=a=>oe(i)?i.value=a:null),type:"text",class:bn({completed:ce(s)})},null,2),[[ua,ce(i)]])]),re("button",{class:"destroy",title:"delete todo",onClick:o})]),Fy]))}});const By=Oo(Ly,[["__scopeId","data-v-064692d8"]]),Gu=t=>(Uc("data-v-547471e1"),t=t(),Wc(),t),Uy={class:"todoapp"},Wy=["onSubmit"],Hy=Gu(()=>re("h1",null,"Jared's Todos",-1)),Vy={class:"main"},$y=Gu(()=>re("input",{id:"sort-todos",class:"toggle-all",type:"checkbox"},null,-1)),jy={key:0,class:"todo-list"},Ky={class:"footer"},zy={class:"todo-count"},qy={class:"filters"},Gy=ci({__name:"App",setup(t){const e=qu();e.loadData(),$t(0);const n=$t(lt.DESCENDING),s=$t("");function i(u){e.destroyTodo(u)}function r(){e.clearCompleted()}function o(u){e.setFilter(u)}function l(){n.value=(n.value+1)%3,e.setSort(n.value)}function c(){setTimeout(()=>{e.addTodo(s.value),s.value=""},0)}function a(u){e.updateTodo(u)}return(u,h)=>{const d=By,g=Oy,C=Ud;return rt(),cn("section",Uy,[re("form",{class:"header",onSubmit:xd(c,["prevent"])},[Hy,Zi(re("input",{type:"text","onUpdate:modelValue":h[0]||(h[0]=E=>oe(s)?s.value=E:null),class:"new-todo",placeholder:"What needs to be done?",autofocus:""},null,512),[[ua,ce(s)]])],40,Wy),re("section",Vy,[$y,re("label",{for:"sort-todos",title:"Sort todos",class:bn(["sort-arrow",{"sort-arrow-right":ce(n)===ce(lt).UNSORTED,"sort-arrow-up":ce(n)===ce(lt).ASCENDING,"sort-arrow-down":ce(n)===ce(lt).DESCENDING}]),onClick:l},"Sort todos",2),ce(e).todos?(rt(),cn("ul",jy,[(rt(!0),cn($e,null,Tf(ce(e).todos,E=>(rt(),rr(d,{key:E.id,modelValue:ce(e).todos[ce(e).todos.findIndex(O=>E.id===O.id)],"onUpdate:modelValue":[O=>ce(e).todos[ce(e).todos.findIndex(U=>E.id===U.id)]=O,O=>a(E)],onDestroyTodo:O=>i(E)},null,8,["modelValue","onUpdate:modelValue","onDestroyTodo"]))),128)),ce(e).todos.length===0?(rt(),rr(g,{key:0})):il("",!0)])):il("",!0)]),re("footer",Ky,[re("span",zy,[re("strong",null,Ki(ce(e).tasksLeft),1),ra(" item"+Ki(ce(e).tasksLeft===1?"":"s")+" left",1)]),re("ul",qy,[re("li",null,[Ue(C,{type:"button",active:ce(e).filter==="all",label:{displayText:"All",value:"all"},onClick:o},null,8,["active"])]),re("li",null,[Ue(C,{type:"button",active:ce(e).filter==="unchecked",label:{displayText:"Unchecked",value:"unchecked"},onClick:o},null,8,["active"])]),re("li",null,[Ue(C,{type:"button",active:ce(e).filter==="checked",label:{displayText:"Checked",value:"checked"},onClick:o},null,8,["active"])])]),re("button",{type:"button",class:"clear-completed",onClick:r}," Clear completed ")])])}}});const Yy=Oo(Gy,[["__scopeId","data-v-547471e1"]]),Yu=Ad(Yy),Qy=Od();Yu.use(Qy);Yu.mount("#app");
